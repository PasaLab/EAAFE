                ...
                for action in actions:
                    ...
                    if fe2Name in self.cat_columns:
                        ...
                        if action_binary == 0:
                            ...
                            fe = self.transform_dict['cat2cat'][action_binary].transform(fe, fe2, self.spark)
                        ...
                        if action_binary == 0:
                            ...
                            fe = self.transform_dict['cat2num'][action_binary].transform(fe, fe2, self.spark)
                ...
                for action in actions:
                    ...
                    if action in range(-self.num_op_num, 1):
                        ...
                        #     break
                            ...
                            fe = self.transform_dict['num'][action].transform(fe, self.spark)
                    else:
                        ...
                        if action_binary == 0:
                            ...
                            fe = self.transform_dict['num2num'][action_binary].transform(fe, fe2, self.spark)
